...
function Navbar() {
  return (
    <div className="navbar bg-base-100 shadow-sm flex flex-row-reverse justify-between items-center w-full ">
      <div className="w-3/6">
        <a className="btn btn-ghost text-xl flex justify-end items-center">
          قهوه داینو
        </a>
      </div>
      <div className="flex gap-2 justify-start  items-center w-3/6">
        <div className="dropdown dropdown-start">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content bg-base-100 rounded-box absolute mt-3 w-28 p-2 shadow z-50"
          >
            <li>
        ...
        <p className="font-black text-xs">مسعود جلیلی</p>
      </div>
    </div>
  );
}
